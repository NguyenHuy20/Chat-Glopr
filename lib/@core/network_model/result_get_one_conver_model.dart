...
class ResultGetOneConverModel extends BaseModel {
  ResultGetOneConverModel({this.data, success, statusCode, message})
      : super(success: success, message: message, statusCode: statusCode);
  ConversationData? data;

  factory ResultGetOneConverModel.fromJson(Map<String, dynamic> json) =>
      ResultGetOneConverModel(
