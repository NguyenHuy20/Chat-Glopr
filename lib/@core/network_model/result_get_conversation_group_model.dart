...
class ResultGetConversationGroupModel extends BaseModel {
  ResultGetConversationGroupModel({this.data, success, statusCode, message})
      : super(success: success, message: message, statusCode: statusCode);
  List<ConversationGroupData>? data;

  factory ResultGetConversationGroupModel.fromJson(Map<String, dynamic> json) =>
      ResultGetConversationGroupModel(
        success: json["success"],
        data: json["data"] != null
            ? List<ConversationGroupData>.from(
                json["data"].map((x) => ConversationGroupData.fromJson(x)))
            : null,
